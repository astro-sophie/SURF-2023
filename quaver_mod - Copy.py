...
# print(len(unstitched_lc_simple_hyb[0]))
# fig_simple_hyb = plt.figure()
# for i in range(0, len(unstitched_lc_simple_hyb)):
#     for j in range(0, len(unstitched_lc_simple_hyb[i])):
#         plt.scatter(unstitched_lc_simple_hyb[i][j][0], unstitched_lc_simple_hyb[i][j][1])
# plt.show()
...
# with open('quaver_output/'+target_safename+'/'+target_safename+'_lcdata_pca.csv', 'w') as f:
#     writer = csv.writer(f)
#     writer.writerows(zip(full_lc_time_pca, full_lc_flux_pca, full_lc_err_pca))
# # if primary_correction_method == 1:
# #         plt.show()
# # plt.close(fig_pca)
...
# with open('quaver_output/'+target_safename+'/'+target_safename+'_lcdata_sh.csv', 'w') as f:
#     writer = csv.writer(f)
#     writer.writerows(zip(full_lc_time_sh, full_lc_flux_sh, full_lc_err_sh))
...
# with open('quaver_output/'+target_safename+'/'+target_safename+'_lcdata_fh.csv', 'w') as f:
#     writer = csv.writer(f)
#     writer.writerows(zip(full_lc_time_fh, full_lc_flux_fh, full_lc_err_fh))
# # if primary_correction_method == 3:
# #     plt.show()
# # plt.close(fig_fh)

# print(additive_rescale_factor)
